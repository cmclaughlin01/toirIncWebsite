...
export default function YourPageNameHere() {
  useEffect(() => {
        ...
        <div className="sideMenuLeft" style={{ textAlign: 'right' }}>
          <div id="menuLeftTrans" className="vertical-center">
            {[
              ...
              ['CAREER', '/career', 'careerHover'],
              ['CONTACT', '/contact', 'contactHover'],
              ['SERVICES', '/services', 'servicesHover']
            ].map(([label, href, hover]) => (
              <div
                className="hoverBlock"
                key={label}
                onMouseOver={() => (window as any).menuHover?.() || (window as any)[hover]?.()}
        ...
        <div className="sideMenuRight">
          <div style={{ marginTop: '10vw', paddingLeft: '2vw' }}>
            <a href="mailto:contact@toirinc.com">
              <p style={{ margin: 0 }}><span style={{ fontSize: '1vw' }}>CONTACT@TOIRINC.COM</span></p>
            </a>
            <div id="menuLeftSpacer" />
            <a href="mailto:career@toirinc.com">
              <p style={{ margin: 0 }}><span style={{ fontSize: '1vw' }}>CAREER@TOIRINC.COM</span></p>
            </a>
            <div id="menuLeftSpacer" />
            <a href="tel:+18446051745">
              <p style={{ margin: 0 }}><span style={{ fontSize: '1vw' }}>844-605-1745</span></p>
            </a>
          </div>
        </div>
      </div>
